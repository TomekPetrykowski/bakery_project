<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $product_price = number_format(floatval($_POST['product_price']), 2, ",", " ");
        ...
        if($valid_data) {
            $query = "INSERT INTO $table_name VALUES (NULL, '$product_name', '$image_path', '$product_desc', '$product_price', '$product_quantity', '$current_date', '$user_id');";

            try {
                if ($connection -> query($query)){
                    $alert = '<p class="success">Pomyślnie dodano produkt!</p>';
                } else {
			...
			<section class="user-main">
				<div class="wrapper">
					...
					<div class="user-main-content">
                        <div class="user-info">
							<h2 class="text-header">Dodawanie produktu</h2>
